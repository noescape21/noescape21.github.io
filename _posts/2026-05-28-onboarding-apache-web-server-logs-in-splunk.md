---
layout: post
title: "Onboarding Apache Web Server Logs in Splunk"
date: 2026-05-28
tags: [splunk, apache, logging, blue-team]
excerpt: "In this blog we will see how we can onboard logs from Apache Web Server in Splunk, configuring inputs.conf, and setting up log formats."
---
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260527193336.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528113545.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528120158.png" %}

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528120255.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528121041.png" %}

Change the Apache access log path to the `splunk_json` format.

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528122131.png" %}

Now specify the `splunk_json` log format there.

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528122636.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528122903.png" %}

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528123036.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528123336.png" %}

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528123522.png" %}

## Splunk Add-on

Install the add-on in Splunk UI and provide your Splunk website credentials when prompted.

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528123643.png" %}

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528125433.png" %}

## inputs.conf

Add `inputs.conf` for shipping the logs.

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528125555.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528132606.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528130457.png" %}
...
{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528130644.png" %}

{% include post-screenshot.html src="/assets/img/posts/Pasted%20image%2020260528132714.png" %}
